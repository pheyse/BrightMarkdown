...
public class BrightMarkdownSection {
	public enum MDType{ROOT, RAW_LINE, PARAGRAPH, PARAGRAPH_ELEMENT, PLAIN_TEXT, HEADING, HORIZONTAL_RULE, BULLET_POINT, NUMBERED_ITEM, BOLD, ITALIC
		, STRIKETHROUGH, LINK, CHECKED_ITEM, UNCHECKED_ITEM, CODE_BLOCK, TABLE_OF_CONTENTS}
	private MDType type;
